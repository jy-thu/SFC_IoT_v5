function [result_P,Total_benifit,exitflag_P,output_P, Accept_num, c_use_result, g_use_result, choosen_nodes, Accepted_Requests] = Solve_PR_batch_NoIterat(...
    beta, P_matrix, V, c_now, g_now, Startfrom, Pointto, alpha, requests_K, cost_up, NoUp, HaveUpCost, idxs_d, Allow, K, gamma)
